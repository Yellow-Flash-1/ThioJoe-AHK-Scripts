...
ShowPathSelectorHelpWindow(*) {
    ...
    elevatedTipText := ""
    if A_IsCompiled {
        elevatedTipText := "• To make this prodram work with dialogs launched by elevated processes without having to run it as admin, place the executable in a trusted location such as `"C:\Program Files\...`""
